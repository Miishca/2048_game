...
function gameOver() {
    for(let row = 0; row < gameFields.length; row++)for(let column = 0; column < gameFields[row].length; column++){
...
function gameIsWin() {
    for(let row = 0; row < gameFields.length; row++){
        for(let column = 0; column < gameFields[row].length; column++)if (gameFields[row][column] === 2048) {
            isWin = true;
...
function moveTilesUp() {
    ...
    for(let column = 0; column < 4; column++){
        let newCol = [];
        for(let row = 0; row < 4; row++)if (gameFields[row][column] !== 0) newCol.push(gameFields[row][column]);
        ...
        for(let row = 0; row < 4; row++){
            if (gameFields[row][column] !== newCol[row]) moved = true;
...
function generateRandomNumber() {
    const emptyCells = [];
    for(let row = 0; row < 4; row++){
        for(let column = 0; column < 4; column++)if (gameFields[row][column] === 0) emptyCells.push({
            row,
            column
        });
    }
  ...
  `;
    ...
    for(let i = 0; i < gameFields.length; i++){
        ...
        for(let j = 0; j < gameFields[i].length; j++){
            ...
            else cell.classList.add(`field-cell--${cellValue}`);
